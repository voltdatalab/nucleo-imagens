/*! For license information please see sodo-search.min.js.LICENSE.txt */ ! function(e) {
    ...
    (function(module) {
        (function _f(self) {
            ...
            P("add"), P("append"), P("search"), P("update"), P("remove"), t = Q.prototype, t.add = function(e, t, n) {
                ...
                for (var O, _ = 0; _ < f.length; _++) {
                    if ((O = c[_]).length && u && (O = za.call(this, O)), o) return O;
                    c[_] = {
                        field: f[_],
                        result: O
                    }
    ...
    (function(e, r, o) {
        ...
        var a, l, s = function(e) {
            ...
            I = C({}.isPrototypeOf),
            M = L("navigator", "userAgent") || "",
            U = c.process,
            z = c.Deno,
            V = U && U.versions || z && z.version,
            q = V && V.v8;
        q && (l = (a = q.split("."))[0] > 0 && a[0] < 4 ? 1 : +(a[0] + a[1])), !l && M && (!(a = M.match(/Edge\/(\d+)/)) || a[1] >= 74) && (a = M.match(/Chrome\/(\d+)/)) && (l = +a[1]);
        var W = l,
            ...
            Pe = function(e) {
                if (R(e)) return e;
                throw je(_e(e) + " is not an object")
            },
            Be = c.TypeError,
            Te = Object.defineProperty,
        ...
        var st = {
            ...
            ft = function(e, t, n, r) {
                ...
                return T(n) && ct(n, u, r), r.global ? o ? e[t] = n : ne(t, n) : (r.unsafe ? e[t] && (o = !0) : delete e[t], o ? e[t] = n : Ue(e, t, n)), e
            },
            dt = Math.ceil,
            ht = Math.floor,
            ...
            wt = function(e) {
                return function(t, n, r) {
                    ...
                    if (e && n != n) {
                        ...
                        for (; i > a; a++)
                            if ((e || a in u) && u[a] === n) return e || a || 0; return !e && -1
                }
            },
            Et = {
                includes: wt(!0),
            ...
            _t = C([].concat),
            jt = L("Reflect", "ownKeys") || function(e) {
                var t = St.f(Pe(e)),
                    n = Ot.f;
                return n ? _t(t, n(e)) : t
            },
            Pt = function(e, t, n) {
                for (var r = jt(t), o = Me.f, u = Se.f, i = 0; i < r.length; i++) {
                    var a = r[i];
            ...
            zt = function(e, t) {
                ...
                if (n = l ? c : s ? c[a] || ne(a, {}) : (c[a] || {}).prototype)
                    for (r in t) {
                        if (u = t[r], o = e.dontCallGetSet ? (i = Ut(n, r)) && i.value : n[r], !Mt(l ? r : a + (s ? "." : "#") + r, e.forced) && void 0 !== o) {
                            if (typeof u == typeof o) continue;
                            Pt(u, o)
                        }(e.sham || o && o.sham) && Ue(u, "sham", !0), ft(n, r, u, e)
                    }
            },
            Vt = {};
        Vt[ye("toStringTag")] = "z";
        var qt, Wt = "[object z]" === String(Vt),
            ...
            rn = d && !Oe ? Object.defineProperties : function(e, t) {
                Pe(e);
                for (var n, r = B(t), o = nn(t), u = o.length, i = 0; u > i;) Me.f(e, n = o[i++], r[n]);
                return e
            },
            on = {
                f: rn
            ...
            Tn = function(e) {
                return function(t, n) {
                    var r, o, u = Gt(P(t)),
                        i = vt(n),
                        a = u.length;
                    return i < 0 || i >= a ? e ? "" : void 0 : (r = Pn(u, i)) < 55296 || r > 56319 || i + 1 === a || (o = Pn(u, i + 1)) < 56320 || o > 57343 ? e ? jn(u, i) : r : e ? Bn(u, i, i + 2) : o - 56320 + (r - 55296 << 10) + 65536
                }
            },
            Rn = {
                codeAt: Tn(!1),
        ...
        ! function(e, t, n, r) {
            ...
            if (!u || !i || n) {
                ...
                ft(String.prototype, e, l[0]), ft(_n, o, l[1])
            }
            r && Ue(_n[o], "sham", !0)
        ...
        zt({
            ...
            startsWith: function(e) {
                var t = Gt(P(this));
                Dr(e);
                var n = bt(jr(arguments.length > 1 ? arguments[1] : void 0, t.length)),
                    r = Gt(e);
                return Or ? Or(t, r, n) : _r(t, n, n + r.length) === r
            }
        });
        var Br, Tr, Rr, Nr, Lr = "process" == k(c.process),
                ...
                return function(n, r) {
                    return Pe(n),
                        function(e) {
                            ...
                            throw Mr("Can't set " + Ir(e) + " as a prototype")
            ...
            ro = /(?:ipad|iphone|ipod).*applewebkit/i.test(M),
            oo = c.setImmediate,
            uo = c.clearImmediate,
            io = c.process,
            ao = c.Dispatch,
        ...
        var bo, Do, wo, Eo, Fo, Co, xo, Ao, ko = {
            ...
            So = /ipad|iphone|ipod/i.test(M) && void 0 !== c.Pebble,
            Oo = /web0s(?!.*chrome)/i.test(M),
            _o = Se.f,
            jo = ko.set,
        ...
        var _u = {},
            ...
            Bu = ye("iterator"),
            Tu = function(e) {
                if (void 0 != e) return Z(e, Bu) || Z(e, "@@iterator") || _u[Qt(e)]
            },
            Ru = c.TypeError,
            Nu = function(e, t, n) {
                var r, o;
            ...
            Uu = function(e, t, n) {
                ...
                if (h) r = e;
                    ...
                    if (void 0 !== (c = o) && (_u.Array === c || Pu[ju] === c)) {
                        for (u = 0, i = Dt(e); i > u; u++)
                            if ((a = y(e[u])) && I(Mu, a)) return a;
                        return new Iu(!1)
                    }
                    r = function(e, t) {
                ...
                for (l = r.next; !(s = v(l, r)).done;) {
                    ...
                    if ("object" == typeof a && a && I(Mu, a)) return a
                }
                return new Iu(!1)
            },
            zu = ye("iterator"),
        ...
        var Gu = Object.assign,
            ...
            Zu = !Gu || f((function() {
                ...
                for (var n = ae(e), r = arguments.length, o = 1, u = Ot.f, i = y.f; r > o;)
                    for (var a, l = _(arguments[o++]), s = u ? Xu(nn(l), u(l)) : nn(l), c = s.length, f = 0; c > f;) a = s[f++], d && !v(i, l, a) || (n[a] = l[a]);
                return n
            } : Gu;
        zt({
            target: "Object",
        ...
        var ii = {
            ...
            ci = C([].push),
                ...
                return function(l, s, c, f) {
                    for (var d, h, p = ae(l), v = _(p), m = Zr(s, c), g = Dt(v), y = 0, b = f || or, D = t ? b(l, g) : n || i ? b(l, 0) : void 0; g > y; y++)
            ...
            hi = Mn("forEach") ? [].forEach : function(e) {
        ...
        var Bi, Ti = (Bi = "undefined" !== typeof Uint8Array && Object.getPrototypeOf(Uint8Array), function(e) {
            ...
            Ri = {
                ...
                isFormData: function(e) {
                    ...
                    return e && ("function" === typeof FormData && e instanceof FormData || yi.call(e) === t || _i(e.toString) && e.toString() === t)
                },
        ...
        function ja(e, t, n, r) {
            ...
            if (!ka[p])
                for (s = 0, f = Ea.length; s < f; s++) {
                    var O = Ea[s];
                    if (-1 !== a.indexOf(O)) {
                        var _ = encodeURIComponent(O);
                        _ === O && (_ = escape(O)), a = a.split(O).join(_)
                    }
                }
            var j = a.indexOf("#"); - 1 !== j && (e.hash = a.substr(j), a = a.slice(0, j));
            var P = a.indexOf("?");
        ...
        var Ma = {
            ...
            transformRequest: [function(e, t) {
                if (Ui(t, "Accept"), Ui(t, "Content-Type"), Ri.isFormData(e) || Ri.isArrayBuffer(e) || Ri.isBuffer(e) || Ri.isStream(e) || Ri.isFile(e) || Ri.isBlob(e)) return e;
            ...
            transformResponse: [function(e) {
                var t = this.transitional || Ma.transitional,
        ...
        var Wa = function(e) {
                return qa(e), e.headers = e.headers || {}, e.data = za.call(e, e.data, e.headers, e.transformRequest), e.headers = Ri.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers), Ri.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(t) {
                    delete e.headers[t]
                })), (e.adapter || Ua.adapter)(e).then((function(t) {
    ...
    function Qn(e, t, n, r) {
        je(r), 0 < (t = Lr(t, "onChange")).length && (n = new hn("onChange", "change", null, n, r), e.push({
            event: n,
            listeners: t
        }))
    }
    ...
    function Pr(e) {
        e[jr] || (e[jr] = !0, a.forEach((function(t) {
        ...
        if (0 === (1 & t) && 0 === (2 & t) && null !== r) e: for (;;) {
            ...
            e: {
                ...
                if (void 0 !== a) {
                    ...
                    for (var h, p = r; null !== p;) {
                        var v = (h = p).stateNode;
                        if (5 === h.tag && null !== v && (h = v, null !== d && (null != (v = Ue(p, d)) && c.push(Nr(p, v, h)))), f) break;
                        p = p.return
                    }
            ...
            if (0 === (7 & t)) {
                if (l = "mouseout" === e || "pointerout" === e, (!(a = "mouseover" === e || "pointerover" === e) || 0 !== (16 & t) || !(s = n.relatedTarget || n.fromElement) || !no(s) && !s[eo]) && (l || a) && (a = o.window === o ? o : (a = o.ownerDocument) ? a.defaultView || a.parentWindow : window, l ? (l = r, null !== (s = (s = n.relatedTarget || n.toElement) ? no(s) : null) && (s !== (f = Ge(s)) || 5 !== s.tag && 6 !== s.tag) && (s = null)) : (l = null, s = r), l !== s)) {
                    if (c = gn, v = "onMouseLeave", d = "onMouseEnter", p = "mouse", "pointerout" !== e && "pointerover" !== e || (c = jn, v = "onPointerLeave", d = "onPointerEnter", p = "pointer"), f = null == l ? a : oo(l), h = null == s ? a : oo(s), (a = new c(v, p + "leave", l, n, o)).target = f, a.relatedTarget = h, v = null, no(o) === r && ((c = new c(d, p + "enter", s, n, o)).target = h, c.relatedTarget = f, v = c), f = v, l && s) e: {
                    ...
                    null !== l && Mr(i, a, l, c, !1), null !== s && null !== f && Mr(i, f, s, c, !0)
                }
                ...
                b && (Un && "ko" !== n.locale && (Hn || "onCompositionStart" !== b ? "onCompositionEnd" === b && Hn && (y = rn()) : (tn = "value" in (en = o) ? en.value : en.textContent, Hn = !0)), 0 < (g = Lr(r, b)).length && (b = new Fn(b, e, null, n, o), i.push({
                    event: b,
                    listeners: g
    ...
    function Lr(e, t) {
        for (var n = t + "Capture", r = []; null !== e;) {
            var o = e,
                u = o.stateNode;
            5 === o.tag && null !== u && (o = u, null != (u = Ue(e, n)) && r.unshift(Nr(e, u, o)), null != (u = Ue(e, t)) && r.push(Nr(e, u, o))), e = e.return
        }
        return r
    }
    ...
    function Mr(e, t, n, r, o) {
        for (var u = t._reactName, i = []; null !== n && n !== r;) {
            var a = n,
                ...
                s = a.stateNode;
            if (null !== l && l === r) break;
            5 === a.tag && null !== s && (a = s, o ? null != (l = Ue(n, u)) && i.unshift(Nr(n, l, a)) : o || null != (l = Ue(n, u)) && i.push(Nr(n, l, a))), n = n.return
        }
        0 !== i.length && e.push({
            event: t,
            listeners: i
    ...
    function Go() {
        if (!Vo && null !== Uo) {
            ...
            try {
                ...
                throw null !== Uo && (Uo = Uo.slice(e + 1)), ko(Bo, Ko), n
            } finally {
                Vo = !1
            }
        }
    ...
    function Tu(e, t) {
        switch (fo(Pu, t), fo(ju, e), fo(_u, Ou), e = t.nodeType) {
            case 9:
            case 11:
    ...
    function Hu(e) {
        if (Vu) {
            ...
            if (t) {
                var n = t;
                if (!Wu(e, t)) {
                    if (!(t = Qr(n.nextSibling)) || !Wu(e, t)) return e.flags = -1025 & e.flags | 2, Vu = !1, void(Uu = e);
                    qu(Uu, n)
                }
                Uu = e, zu = Qr(t.firstChild)
            } else e.flags = -1025 & e.flags | 2, Vu = !1, Uu = e
        }
    }
    ...
    function $u(e) {
        ...
        } else zu = Uu ? Qr(e.stateNode.nextSibling) : null;
        return !0
    }
    ...
    function pi(e, t, n, r) {
        ...
        return e.memoizedState = {
            ...
            lastRenderedState: f
        }).dispatch = c = ji.bind(null, ei, e), s.queue = e, s.baseQueue = null, f = hi(o, t, n), s.memoizedState = s.baseState = f), f
    }
    ...
    function oa(e, t, n) {
        ...
        if (fo(Iu, r), 0 === (2 & t.mode)) t.memoizedState = null;
            ...
            case "forwards":
                for (n = t.child, o = null; null !== n;) null !== (e = n.alternate) && null === Mu(e) && (o = n), n = n.sibling;
        ...
        switch (t.tag) {
            ...
            case 5:
                ...
                if (n = t.type, null !== e && null != t.stateNode) Ki(e, t, n, r), e.ref !== t.ref && (t.flags |= 128);
                    ...
                    if (e = Bu(_u.current), $u(t)) {
                        ...
                        for (var s in Ce(n, a), e = null, a) a.hasOwnProperty(s) && (u = a[s], "children" === s ? "string" === typeof u ? r.textContent !== u && (e = ["children", u]) : "number" === typeof u && r.textContent !== "" + u && (e = ["children", "" + u]) : l.hasOwnProperty(s) && null != u && "onScroll" === s && _r("scroll", r));
                        switch (n) {
                            case "input":
                                G(r), re(r, a, !0);
                                break;
                        ...
                        switch (s = 9 === u.nodeType ? u : u.ownerDocument, e === fe && (e = he(n)), e === fe ? "script" === n ? ((e = s.createElement("div")).innerHTML = "<script><\/script>", e = e.removeChild(e.firstChild)) : "string" === typeof r.is ? e = s.createElement(n, {
                            ...
                            case "video":
                            case "audio":
                                for (u = 0; u < Ar.length; u++) _r(Ar[u], e);
                                u = r;
                                break;
                            case "source":
                                _r("error", e), u = r;
                        ...
                        for (a in c)
                            if (c.hasOwnProperty(a)) {
                                var f = c[a];
                                "style" === a ? Ee(e, f) : "dangerouslySetInnerHTML" === a ? null != (f = f ? f.__html : void 0) && ge(e, f) : "children" === a ? "string" === typeof f ? ("textarea" !== n || "" !== f) && ye(e, f) : "number" === typeof f && ye(e, "" + f) : "suppressContentEditableWarning" !== a && "suppressHydrationWarning" !== a && "autoFocus" !== a && (l.hasOwnProperty(a) ? null != f && "onScroll" === a && _r("scroll", e) : null != f && D(e, a, f, s))
                            }
                        switch (n) {
                            case "input":
                                G(e), re(e, r, !1);
                            ...
                            case "select":
                                ...
                                break;
                            default:
                                "function" === typeof u.onClick && (e.onclick = Ur)
                        }
                        qr(n, r) && (t.flags |= 4)
                    }
            ...
            case 6:
                if (e && null != t.stateNode) Gi(0, t, e.memoizedProps, r);
                    ...
                    n = Bu(Pu.current), Bu(_u.current), $u(t) ? (r = t.stateNode, n = t.memoizedProps, r[Xr] = t, r.nodeValue !== n && (t.flags |= 4)) : ((r = (9 === n.nodeType ? n : n.ownerDocument).createTextNode(r))[Xr] = t, t.stateNode = r)
                }
                return null;
            case 13:
        ...
        if (u !== r) {
            ...
            switch (n) {
                ...
                case "textarea":
                    ...
                    break;
                default:
                    "function" !== typeof u.onClick && "function" === typeof r.onClick && (e.onclick = Ur)
            }
    ...
    function hl(e) {
        ...
        if (0 === ll && (ll = Ua), 0 !== Jo.transition) {
            0 !== sl && (sl = null !== Wa ? Wa.pendingLanes : 0), e = ll;
            var t = 4186112 & ~sl;
            return 0 === (t &= -t) && (0 === (t = (e = 4186112 & ~e) & -e) && (t = 8192)), t
        }
        return e = Ho(), 0 !== (4 & Pa) && 98 === e ? e = Ut(12, ll) : e = Ut(e = function(e) {
            switch (e) {
                case 99:
                    return 15;
                case 98:
    ...
    function ml(e, t) {
        ...
        if (r = It(e, e === Ba ? Ra : 0), t = Nt, 0 === r) null !== n && (n !== Io && So(n), e.callbackNode = null, e.callbackPriority = 0);
            ...
            15 === t ? (n = bl.bind(null, e), null === Uo ? (Uo = [n], zo = ko(Bo, Go)) : Uo.push(n), n = Io) : 14 === t ? n = Qo(99, bl.bind(null, e)) : (n = function(e) {
                switch (e) {
                    case 15:
                    case 14:
                        return 99;
    ...
    function gl(e) {
        ...
        if (ru(), _a.current = u, Pa = o, null !== Ta ? r = 0 : (Ba = null, Ra = 0, r = Ia), 0 !== (Ua & Va)) Cl(e, 0);
        else if (0 !== r) {
            if (2 === r && (Pa |= 64, e.hydrate && (e.hydrate = !1, $r(e.containerInfo)), 0 !== (n = Mt(e)) && (r = kl(e, n))), 1 === r) throw t = Ma, Cl(e, 0), yl(e, n), ml(e, Wo()), t;
    ...
    function bl(e) {
        ...
        if (Rl(), e === Ba && 0 !== (e.expiredLanes & Ra)) {
            var t = Ra,
                n = kl(e, t);
            0 !== (Ua & Va) && (n = kl(e, t = It(e, t)))
        } else n = kl(e, t = It(e, 0));
        if (0 !== e.tag && 2 === n && (Pa |= 64, e.hydrate && (e.hydrate = !1, $r(e.containerInfo)), 0 !== (t = Mt(e)) && (n = kl(e, t))), 1 === n) throw n = Ma, Cl(e, 0), yl(e, t), ml(e, Wo()), n;
    ...
    function Cl(e, t) {
        ...
        Ba = e, Ta = Yl(e.current, null), Ra = Na = Ua = t, Ia = 0, Ma = null, qa = Va = za = 0
    }
    ...
    function xl(e, t) {
        for (;;) {
            ...
            try {
                ...
                if (Zu = 0, ni = ti = ei = null, oi = !1, ja.current = null, null === n || null === n.return) {
                    Ia = 1, Ma = t, Ta = null;
                    break
                }
                e: {
    ...
    function kl(e, t) {
        ...
        if (ru(), Pa = n, _a.current = r, null !== Ta) throw Error(i(261));
    ...
    function Ol() {
        for (; null !== Ta && !Oo();) _l(Ta)
    }

    function _l(e) {
        var t = Qa(e.alternate, e, Na);
        e.memoizedProps = e.pendingProps, null === t ? jl(e) : Ta = t, ja.current = null
    }
    ...
    function Bl(e, t) {
        ...
        if (null !== ol && 0 === (24 & r) && ol.has(e) && ol.delete(e), e === Ba && (Ta = Ba = null, Ra = 0), 1 < n.flags ? null !== n.lastEffect ? (n.lastEffect.nextEffect = n, r = n.firstEffect) : r = n : r = n.firstEffect, null !== r) {
            if (o = Pa, Pa |= 32, ja.current = null, zr = Kt, gr(a = mr())) {
    ...
    function Vl(e, t) {
        var n = e.stateNode;
        null !== n && n.delete(t), 0 === (t = 0) && (0 === (2 & (t = e.mode)) ? t = 1 : 0 === (4 & t) ? t = 99 === Ho() ? 1 : 2 : (0 === ll && (ll = Ua), 0 === (t = zt(62914560 & ~ll)) && (t = 4194304))), n = dl(), null !== (e = vl(e, t)) && (qt(e, t, n), ml(e, n))
    }
    ...
    function $l(e, t, n, r, o, u) {
        ...
        if (r = e, "function" === typeof e) Hl(e) && (a = 1);
            ...
            case _:
                return (e = Wl(13, n, t, o)).type = _, e.elementType = _, e.lanes = u, e;
            case j:
                return (e = Wl(19, n, t, o)).elementType = j, e.lanes = u, e;
            case L:
                return Kl(n, o, u, t);
            case I:
        ...
        switch (t.lanes = 0, t.tag) {
            ...
            case 3:
                ...
                if (r = t.pendingProps, o = null !== (o = t.memoizedState) ? o.element : null, cu(e, t), pu(t, r, null, n), (r = t.memoizedState.element) === o) Qu(), t = ua(e, t, n);
                    ...
                    if ((u = (o = t.stateNode).hydrate) && (zu = Qr(t.stateNode.containerInfo.firstChild), Uu = t, u = Vu = !0), u) {
            ...
            case 14:
                return u = Xo(o = t.type, t.pendingProps), Ui(e, t, o, u = Xo(o.type, u), r, n);
            case 15:
    ...
    function L(e, n) {
        ...
        var r = j;
        try {
            for (R(n), _ = C(k); null !== _ && (!(_.expirationTime > n) || e && !t.unstable_shouldYield());) {
                var i = _.callback;
                if ("function" === typeof i) {
                    _.callback = null, j = _.priorityLevel;
                    var a = i(_.expirationTime <= n);
                    n = t.unstable_now(), "function" === typeof a ? _.callback = a : _ === C(k) && x(k), R(n)
                } else x(k);
                _ = C(k)
            }
            if (null !== _) var l = !0;
    ...
    function J() {
        ...
        return t || (i = "z-10 relative flex items-center py-5 px-4 sm:px-7 bg-white rounded-lg"), Object(O.jsxs)("div", {
            ...
            children: [Object(O.jsx)("div", {
                ...
                placeholder: "Busque por publicações, tags e autores"
    ...
    function le(e) {
        ...
        return null === t || void 0 === t || !t.length || n >= (null === t || void 0 === t ? void 0 : t.length) ? null : Object(O.jsx)("button", {
            ...
            children: "Mostrar mais resultados"
        })
    }
        ...
        return b(n, [{
            ...
            value: function() {
                var e = "\n            :root {\n                --brandcolor: ".concat(this.context.brandColor || "", "\n            }\n\n            .ghost-display {\n                display: none;\n            }\n        "),
                    t = function(e) {
                        var t = e.appVersion;
                        return t ? "https://unpkg.com/@tryghost/sodo-search@~".concat(t, "/umd/main.css") : "http://localhost:3000/main.css"
                    }({
